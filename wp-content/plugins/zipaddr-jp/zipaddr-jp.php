...
*/
define('zipaddr_VERS', '1.23');
define('zipaddr_KEYS', 'zipaddr-config');
define('zipaddr_SYS',  'sys_');
define('zipaddr_COM',  'https://zipaddr.com/');
define('zipaddr2',     'http://zipaddr2.com/');
define('zipaddr2COM',  'https://zipaddr.github.io/');
define('zipaddr3COM',  'http://zipaddr3.com/');
//define('zipaddr2sCOM', 'https://zipaddr2-com.ssl-sixcore.jp/');
define('zipaddr3sCOM', 'https://zipaddr3-com.ssl-sixcore.jp/');
